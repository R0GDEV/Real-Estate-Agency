...
function MyPropertie() {
        ...
        const fetchProperties = async () => {
            try {
                ...
                const response = await axios.post(
                    'https://real-estate-agency-beckend.onrender.com/api/properties/myproperties',
                    {
                        token
                    }
                );
    ...
    const handleDeleteProperty = async (propertyId: string) => {
        try {
            ...
            const response = await axios.delete(`https://real-estate-agency-beckend.onrender.com/api/properties/${propertyId}`,
                {
                  headers: {
